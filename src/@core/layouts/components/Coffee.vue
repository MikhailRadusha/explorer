...
export default {
  ...
  data() {
    return {
      erc20: '0xbb0e0Dbea1F48d483DDb7dE0160fA7FC492E7093',
      selectedAddress: 'cosmos1p897yys9cj2r28w3hljqczsaf2rjde889uhtcd',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos1p897yys9cj2r28w3hljqczsaf2rjde889uhtcd')
